...
import magnisys from "../../../assets/images/logos/meganysis.png";
import image from "next/image";
      ...
      <div className="header1 po-relative">
        <Container>
          <Navbar className="navbar-expand-lg h1-nav">
            <NavbarBrand href="#">
              <Image src={magnisys} alt="wrapkit"
                width={110} height={110} quality={70} />
            </NavbarBrand>
              ...
              <Nav navbar className="ml-auto mt-2 mt-lg-0">
                ...
                <UncontrolledDropdown nav inNavbar>
                  ...
                  <DropdownMenu className="b-none animated fadeInUp">
                    <DropdownItem>Hybrid App Development</DropdownItem>
                    <DropdownItem>Web Development</DropdownItem>
                    <DropdownItem>Digital Marketing</DropdownItem>
                    <DropdownItem divider />
                    <DropdownItem>Automation testing</DropdownItem>
                    <DropdownItem>Cloud & Supports</DropdownItem>
                    <DropdownItem divider />
                    <DropdownItem>Producation Support</DropdownItem>
                  </DropdownMenu>
                </UncontrolledDropdown>
                <NavItem>
