    ...
    <div>
      ...
      <div className="spacer">
        <Container>
          <Row className="justify-content-center">
            <Col md="7" className="text-center">
              <h2 className="title">Our Robust Suite Of IT Consulting Services</h2>
              <h6 className="subtitle">
            ...
            <Col md="4">
              <Card className="card-shadow">
                ...
                <CardBody>
                  ...
                  <p className="m-b-0 font-14">Develop and manage decentralized solutions in the global financial sector.</p>
                </CardBody>
              </Card>
            </Col>
            <Col md="4">
              <Card className="card-shadow">
                ...
                <CardBody>
                  <h5 className="font-medium m-b-0">Hybrid App Development</h5>
                  <p className="m-b-0 font-14">we are experts in developing native and cross-platform mobile apps suitable for all business verticals.</p>
                </CardBody>
              </Card>
            </Col>
            <Col md="4">
